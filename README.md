# Проектная работа REST API для [проекта "Mesto"](https://github.com/KatyaPesnya/mesto-react).Создана в рамках учебы в Яндекс.Практикум на курсе "Веб-разработчик".
